...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 119 "snick_parse.mly"
               ( incr expr_count; { expr = Ebool _1; id = !expr_count } )
# 627 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 120 "snick_parse.mly"
              ( incr expr_count; { expr = Eint _1; id = !expr_count } )
# 634 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 121 "snick_parse.mly"
                ( incr expr_count; { expr = Efloat _1; id = !expr_count } )
# 641 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 122 "snick_parse.mly"
          ( incr expr_count; { expr = EId _1; id = !expr_count} )
# 648 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : string) in
    ...
    Obj.repr(
# 123 "snick_parse.mly"
                                     ( incr expr_count; { expr = Earray (_1, List.rev _3); id = !expr_count } )
# 656 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 125 "snick_parse.mly"
                   (incr expr_count; { expr = Ebinop (_1, (Op_add, Prec_addsub, Left_assoc), _3); id = !expr_count } )
# 664 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 126 "snick_parse.mly"
                    (incr expr_count; { expr = Ebinop (_1, (Op_sub, Prec_addsub, Left_assoc), _3); id = !expr_count } )
# 672 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 127 "snick_parse.mly"
                  (incr expr_count; { expr = Ebinop (_1, (Op_mul, Prec_muldiv, Left_assoc), _3); id = !expr_count } )
# 680 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 128 "snick_parse.mly"
                  (incr expr_count; { expr = Ebinop (_1, (Op_div, Prec_muldiv, Left_assoc), _3); id = !expr_count } )
# 688 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 129 "snick_parse.mly"
                 (incr expr_count; { expr = Ebinop (_1, (Op_eq, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 696 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 130 "snick_parse.mly"
                  (incr expr_count; { expr = Ebinop (_1, (Op_neq, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 704 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 131 "snick_parse.mly"
                 (incr expr_count; { expr = Ebinop (_1, (Op_lt, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 712 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 132 "snick_parse.mly"
                 (incr expr_count; { expr = Ebinop (_1, (Op_gt, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 720 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 133 "snick_parse.mly"
                   (incr expr_count; { expr = Ebinop (_1, (Op_lteq, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 728 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 134 "snick_parse.mly"
                   (incr expr_count; { expr = Ebinop (_1, (Op_gteq, Prec_eq, Non_assoc), _3); id = !expr_count } )
# 736 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 135 "snick_parse.mly"
                 (incr expr_count; { expr = Ebinop (_1, (Op_or, Prec_or, Left_assoc), _3); id = !expr_count } )
# 744 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    ...
    Obj.repr(
# 136 "snick_parse.mly"
                  (incr expr_count; { expr = Ebinop (_1, (Op_and, Prec_and, Left_assoc), _3); id = !expr_count } )
# 752 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 137 "snick_parse.mly"
             (incr expr_count; { expr = Eunop ((Op_not, Prec_not, Left_assoc), _2); id = !expr_count } )
# 759 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 138 "snick_parse.mly"
                            (incr expr_count; { expr = Eunop ((Op_minus, Prec_uminus, Non_assoc), _2); id = !expr_count } )
# 766 "snick_parse.ml"
               : 'expr))
; (fun __caml_parser_env ->
